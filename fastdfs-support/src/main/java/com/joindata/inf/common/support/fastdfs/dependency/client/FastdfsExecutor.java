...
import com.joindata.inf.common.support.fastdfs.dependency.client.exchange.ReplierDecoder;
import com.joindata.inf.common.support.fastdfs.dependency.client.exchange.Requestor;
import com.joindata.inf.common.support.fastdfs.dependency.client.exchange.RequestorEncoder;
...
final class FastdfsExecutor implements Closeable
{
    ...
    FastdfsExecutor(FastdfsSettings settings)
    {
        ...
        poolGroup = new FastdfsPoolGroup(loopGroup, settings.connectTimeout(), settings.readTimeout(), settings.idleTimeout(), settings.maxConnPerHost());
    }
